...
function travel_scripts() {
	...
	wp_enqueue_style( 'owl-default-style', get_template_directory_uri() . '/assets/vendors/carousel/dist/assets/owl.theme.default.css' );

	wp_deregister_script('jquery');

	wp_enqueue_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js', [], null, true);
	
	wp_enqueue_script( 'travel-navigation', get_template_directory_uri() . '/assets/js/navigation.js', [], null, true );
